...
|dataFormat|雷达数据格式： <p>1: 武汉大学标准1064 nm激光雷达数据</p> <p>2: 武汉大学小型1064 nm激光雷达数据</p> <p>3: BIN格式二进制数据 (老版本)</p> <p>4: 大舜海雾激光雷达数据</p> <p>5: REAL数据</p>  <p>6: BIN格式二进制数据 (新版本2021年)</p>  <p>7: ALA采集卡一般数据格式</p>|3|
