...
dataFormat1 = 3;
dataFormat2 = 1;
chTag1 = {'532p', '532s', '355e', '607', '1064e'};
chTag2 = {'1064e'};
...
%% read data
oData1 = readLidarData(fileparts(dataFile1), 'dataFormat', dataFormat1, 'dataFilePattern', rmext(basename(dataFile1)), 'nMaxBin', 8000, 'nBin', 8000);
oData2 = readLidarData(fileparts(dataFile2), 'dataFormat', dataFormat2, 'dataFilePattern', rmext(basename(dataFile2)));

%% data visualization

% test
displayLidarProfile(oData1, chTag1, 'figTitle', lidarType1);
displayLidarProfile(oData2, chTag2, 'figTitle', lidarType2, 'sigRange', [1e2, 1e5], 'rcsRange', [1e6, 1e10], 'bgRange', [-10, 10], 'gliding_window', 10);
