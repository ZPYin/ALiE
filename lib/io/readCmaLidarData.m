...
data.nEffBin = unique(nBin);   % number of range bins.
data.recWL = recWL;   % receiving wavelength. (nm)
data.ChType = ChType;   % channel type: elastic (0); parallel (1); cross (2); Raman (3);
data.hBlindZone = hBlindZone;
