...
%    timezone:
%        timezone shift in hours. (8 hours for Beijing)
%
% OUTPUTS:
%    data: struct
...
addParameter(p, 'timezone', 0, @isnumeric);
...
for iFile = 1:length(dataFiles)
    ...
    mTime = datenum(dataFiles{iFile}((end-16):(end-4)), 'yymmdd-HHMMSS') + datenum(0, 1, 0, p.Results.timezone, 0, 0);
