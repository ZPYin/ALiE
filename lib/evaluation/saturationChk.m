...
for iCh = 1:length(lidarConfig.chTag)
    ...
    if ~ isempty(lidarConfig.saturationChkCfg.tRange)
        tRange1 = [datenum(lidarConfig.saturationChkCfg.tRange{1}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.saturationChkCfg.tRange{1}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    else
        tRange1 = [];
    end
    if ~ isempty(lidarConfig.saturationChkCfg.tRange)
        tRange2 = [datenum(lidarConfig.saturationChkCfg.tRange{2}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.saturationChkCfg.tRange{2}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    else
        tRange2 = [];
    end
    if ~ isempty(lidarConfig.saturationChkCfg.tRange)
        tRange3 = [datenum(lidarConfig.saturationChkCfg.tRange{3}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.saturationChkCfg.tRange{3}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    else
        tRange3 = [];
    end
    if ~ isempty(lidarConfig.saturationChkCfg.tRange)
        tRange4 = [datenum(lidarConfig.saturationChkCfg.tRange{4}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.saturationChkCfg.tRange{4}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    else
        tRange4 = [];
    end
    if ~ isempty(lidarConfig.saturationChkCfg.tRange)
        tRange5 = [datenum(lidarConfig.saturationChkCfg.tRange{5}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.saturationChkCfg.tRange{5}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    else
        tRange5 = [];
    end
    ...
    if any(~ isnan(sigT1Tmp))
        hShaded = patch([(100 - lidarConfig.saturationChkCfg.maxDev(iCh)) / 100 * sigT1Tmp(~ isnan(sigT1Tmp)); ...
                         (100 + lidarConfig.saturationChkCfg.maxDev(iCh)) / 100 * flipud(sigT1Tmp(~ isnan(sigT1Tmp)))], ...
                        [lidarData.height(~ isnan(sigT1Tmp)); flipud(lidarData.height(~ isnan(sigT1Tmp)))], ...
                        [211, 211, 211]/255); ...
        hold on;
        hShaded.FaceAlpha = 0.6;
        hShaded.EdgeColor = 'None';
    end
    p2 = semilogx(sigT2Tmp, lidarData.height, ...
        'Color', [106, 142, 34]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '80'); hold on;
    p3 = semilogx(sigT3Tmp, lidarData.height, ...
        'Color', [0, 191, 254]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '50');
    p4 = semilogx(sigT4Tmp, lidarData.height, ...
        'Color', [230, 216, 189]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '20');
    p5 = semilogx(sigT5Tmp, lidarData.height, ...
        'Color', [165, 118, 30]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '10');
    p1 = semilogx(sigT1Tmp, lidarData.height, ...
        'Color', 'k', ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '100');
    ...
    figure('Position', [0, 10, 300, 400], ...
           ...
           'Color', 'w', ...
           'Visible', lidarConfig.figVisible);
    p2 = plot(dev2, lidarData.height, ...
        'Color', [106, 142, 34]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '80');
    hold on;
    p3 = plot(dev3, lidarData.height, ...
        'Color', [0, 191, 254]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '50');
    p4 = plot(dev4, lidarData.height, ...
        'Color', [230, 216, 189]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '20');
    p5 = plot(dev5, lidarData.height, ...
        'Color', [165, 118, 30]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', '10');
