...
% standard lidar
cmpRaman = cat(2, cmpRaman, nanmean(allData.(lidarType{1}).(['sig', config.externalChkCfg.RamanCmpCfg.RamanChTag{1}])(:, isChosen), 2));
cmpMie = cat(2, cmpMie, nanmean(allData.(lidarType{1}).(['sig', config.externalChkCfg.RamanCmpCfg.MieChCompose{1}{1}]) + ...
                        allData.(lidarType{1}).(['sig', config.externalChkCfg.RamanCmpCfg.MieChCompose{1}{2}]) * ...
                        config.externalChkCfg.RamanCmpCfg.MieChCompose{1}{3}, 2));
...
for iLidar = 2:length(lidarType)
    ...
    if ~ any(isChosen)
        ...
        thisRaman = nanmean(allData.(lidarType{iLidar}).(['sig', config.externalChkCfg.RamanCmpCfg.RamanChTag{iLidar}])(:, isChosen), 2);
        thisMie = nanmean(allData.(lidarType{iLidar}).(['sig', config.externalChkCfg.RamanCmpCfg.MieChCompose{iLidar}{1}]) + ...
                  allData.(lidarType{iLidar}).(['sig', config.externalChkCfg.RamanCmpCfg.MieChCompose{iLidar}{2}]) * ...
                  config.externalChkCfg.RamanCmpCfg.MieChCompose{iLidar}{3}, 2);
    end
...
%% signal smoothing
cmpRamanSm = NaN(size(cmpRaman));
cmpMieSm = NaN(size(cmpMie));
for iLidar = 1:length(lidarType)
    cmpRamanSm(:, iLidar) = smoothWin(cmpRaman(:, iLidar), piecewiseSM, 'moving');
    cmpMieSm(:, iLidar) = smoothWin(cmpMie(:, iLidar), piecewiseSM, 'moving');
end
...
for iLidar = 1:length(lidarType)
    aExt(:, iLidar) = LidarRamanExt(reshape(height, 1, []), ...
        reshape(cmpRamanSm(:, iLidar), 1, []), ...
        config.externalChkCfg.RamanCmpCfg.wavelengthMie, ...
        config.externalChkCfg.RamanCmpCfg.wavelengthRaman, 1, ...
        reshape(pressure, 1, []), ...
        reshape(temperature, 1, []) + 273.14, 20, 360, 80, 'moving');
    aBsc(:, iLidar) = LidarRamanBsc(reshape(height, 1, []), ...
        reshape(cmpMieSm(:, iLidar), 1, []), ...
        reshape(cmpRamanSm(:, iLidar), 1, []), ...
        reshape(aExt(:, iLidar), 1, []), 1, ...
        reshape(mExt, 1, []), reshape(mBsc, 1, []), ...
...
for iES = 1:nES
    p3 = plot([-1, -1] * config.externalChkCfg.RamanCmpCfg.maxBscDev(iES, 1), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '--', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2, ...
        'DisplayName', 'Mean Dev.');
    plot([1, 1] * config.externalChkCfg.RamanCmpCfg.maxBscDev(iES, 1), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '--', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2);
...
for iPatch = 1:nES
    hShaded = patch(...
        [config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 1), ...
         config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 1), ...
         -config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 1), ...
         -config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 1)], ...
...
for iES = 1:nES
    p4 = plot([-1, -1] * config.externalChkCfg.RamanCmpCfg.maxBscDev(iES, 2), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '-.', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2, ...
        'DisplayName', 'Standard Dev.');
    plot([1, 1] * config.externalChkCfg.RamanCmpCfg.maxBscDev(iES, 2), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '-.', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2);
...
for iPatch = 1:nES
    hShaded = patch(...
        [config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 2), ...
         config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 2), ...
         -config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 2), ...
         -config.externalChkCfg.RamanCmpCfg.maxBscDev(iPatch, 2)], ...
        [config.externalChkCfg.RamanCmpCfg.hChkRange(iPatch, 1), ...
...
% error bound (mean deviation)
for iES = 1:nES
    p3 = plot([-1, -1] * config.externalChkCfg.RamanCmpCfg.maxExtDev(iES, 1), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '--', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2, ...
        'DisplayName', 'Mean Dev.');
    plot([1, 1] * config.externalChkCfg.RamanCmpCfg.maxExtDev(iES, 1), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '--', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2);
...
for iPatch = 1:nES
    hShaded = patch(...
        [config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 1), ...
         config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 1), ...
         -config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 1), ...
         -config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 1)], ...
        [config.externalChkCfg.RamanCmpCfg.hChkRange(iPatch, 1), ...
...
% error bound (standard deviation)
for iES = 1:nES
    p4 = plot([-1, -1] * config.externalChkCfg.RamanCmpCfg.maxExtDev(iES, 2), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '-.', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2, ...
        'DisplayName', 'Standard Dev.');
    plot([1, 1] * config.externalChkCfg.RamanCmpCfg.maxExtDev(iES, 2), ...
        config.externalChkCfg.RamanCmpCfg.hChkRange(iES, :), '-.', ...
        'Color', [160, 160, 160]/255, ...
        'LineWidth', 2);
...
for iPatch = 1:nES
    hShaded = patch(...
        [config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 2), ...
         config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 2), ...
         -config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 2), ...
         -config.externalChkCfg.RamanCmpCfg.maxExtDev(iPatch, 2)], ...
        [config.externalChkCfg.RamanCmpCfg.hChkRange(iPatch, 1), ...
