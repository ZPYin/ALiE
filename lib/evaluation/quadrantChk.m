...
for iCh = 1:length(lidarConfig.chTag)
    ...
    % quadrant time
    east1TRange = [datenum(lidarConfig.quadrantChkCfg.quadrantTime{1}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.quadrantChkCfg.quadrantTime{1}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    southTRange = [datenum(lidarConfig.quadrantChkCfg.quadrantTime{2}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.quadrantChkCfg.quadrantTime{2}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    westTRange = [datenum(lidarConfig.quadrantChkCfg.quadrantTime{3}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                  datenum(lidarConfig.quadrantChkCfg.quadrantTime{3}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    northTRange = [datenum(lidarConfig.quadrantChkCfg.quadrantTime{4}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.quadrantChkCfg.quadrantTime{4}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    east2TRange = [datenum(lidarConfig.quadrantChkCfg.quadrantTime{5}(1:19), 'yyyy-mm-dd HH:MM:SS'), ...
                   datenum(lidarConfig.quadrantChkCfg.quadrantTime{5}(23:41), 'yyyy-mm-dd HH:MM:SS')];
    ...
    if (~ any(isEast1)) || (~ any(isSouth)) || (~ any(isWest)) || (~ any(isNorth)) || (~ any(isEast2))
        warning('Wrong telecover test. Check time slots!');
        continue;
    end
    ...
    fprintf(fid, 'Normalization height range: %f - %f m\n', ...
        lidarConfig.quadrantChkCfg.normRange(iCh, 1), ...
        lidarConfig.quadrantChkCfg.normRange(iCh, 2));
    normInd = (lidarData.height >= lidarConfig.quadrantChkCfg.normRange(iCh, 1)) & ...
              (lidarData.height <= lidarConfig.quadrantChkCfg.normRange(iCh, 2));
    ...
    pEast1 = plot(sigEast1, lidarData.height, ...
        'Color', [106, 142, 34]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'East1');
    hold on;
    pSouth = plot(sigSouth, lidarData.height, ...
        'Color', [0, 191, 254]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'South');
    pWest = plot(sigWest, lidarData.height, ...
        'Color', [230, 216, 189]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'West');
    pNorth = plot(sigNorth, lidarData.height, ...
        'Color', [165, 118, 30]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'North');
    pEast2 = plot(sigEast2, lidarData.height, ...
        'Color', [254, 191, 111]/255, ...
        'LineStyle', '--', ...
        'LineWidth', 2, ...
        'DisplayName', 'East2');
    ...
    figure('Position', [0, 10, 300, 400], ...
           ...
           'Color', 'w', ...
           'Visible', lidarConfig.figVisible);
    pTotal = plot(totalSigNorm, lidarData.height, ...
        'Color', 'k', ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'Total / 4');
    hold on;
    pEast1 = plot(sigEast1Norm, lidarData.height, ...
        'Color', [106, 142, 34]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'East1');
    pSouth = plot(sigSouthNorm, lidarData.height, ...
        'Color', [0, 191, 254]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'South');
    pWest = plot(sigWestNorm, lidarData.height, ...
        'Color', [230, 216, 189]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'West');
    pNorth = plot(sigNorthNorm, lidarData.height, ...
        'Color', [165, 118, 30]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'North');
    pEast2 = plot(sigEast2Norm, lidarData.height, ...
        'Color', [254, 191, 111]/255, ...
        'LineStyle', '--', ...
        'LineWidth', 2, ...
        'DisplayName', 'East2');
    ...
    legend([pTotal, pEast1, pSouth, pWest, pNorth, pEast2], ...
        'Location', 'NorthEast');
    text(0.6, 0.62, sprintf('Version: %s', LEToolboxInfo.programVersion), ...
        'Units', 'Normalized', ...
        'FontSize', 10, ...
    ...
    figure('Position', [0, 10, 300, 400], ...
           ...
           'Color', 'w', ...
           'Visible', lidarConfig.figVisible);
    pEast1 = plot(devEast1, lidarData.height, ...
        'Color', [106, 142, 34]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'East1');
    hold on;
    pSouth = plot(devSouth, lidarData.height, ...
        'Color', [0, 191, 254]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'South');
    pWest = plot(devWest, lidarData.height, ...
        'Color', [230, 216, 189]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'West');
    pNorth = plot(devNorth, lidarData.height, ...
        'Color', [165, 118, 30]/255, ...
        'LineStyle', '-', ...
        'LineWidth', 2, ...
        'DisplayName', 'North');
