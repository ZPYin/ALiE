function [ beta_aer, LR ] = LidarRamanBsc(height, sigElastic, sigVRN2, ext_aer, angstroem, ext_mol, beta_mol, HRef, wavelength, betaRef, window_size, flagSmoothBefore)
% LIDARRAMANBSC calculate the aerosol backscatter coefficient with Raman method.
%
% USAGE:
%    [ beta_aer, LR ] = LidarRamanBsc(height, sigElastic, sigVRN2, ext_aer, ext_mol, beta_mol, HRef, wavelength, betaRef, window_size, flagSmoothBefore)
%
% INPUTS:
%    height: array
%        height. [m]
