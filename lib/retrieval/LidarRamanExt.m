function [ ext_aer ] = LidarRamanExt(height, sig, lambda_emit, ...
    lambda_rec, angstrom, pressure, temperature, window_size, C, rh, ...
    method, measure_error)
% LIDARRAMANEXT retrieve the aerosol extinction coefficient with Raman method
%
% USAGE:
%    [ ext_aer ] = LidarRamanExt(height, sig, lambda_emit, lambda_rec, angstrom, pressure, temperature, window_size, C, rh, method, measure_error)
%
% INPUTS:
%    height: array
%        height[m]
