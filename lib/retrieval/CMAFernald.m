function [aerBsc, aerBscStd, aerBR, aerBRStd] = CMAFernald(alt, signal, bg, LR_aer, refAlt, refBeta, molBsc, window_size)
% CMAFernald retrieve aerosol backscatter coefficient with Fernald method.
%
% USAGE:
%    [aerBsc, aerBscStd, aerBR, aerBRStd] = CMAFernald(alt, signal, bg, LR_aer, refAlt, refBeta, molBsc, window_size)
%
% INPUTS:
%    alt: array
%        height. [m]
